...
export const Route = createFileRoute('/lessons/essential-chords')({
  component: EssentialChordsPage,
  head: () => ({
    meta: [{ title: '10 essential chord shapes · Music KB' }],
  }),
});
